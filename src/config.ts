...
// ─── Brand Identity ───────────────────────────────────────────────────────────
export const BRAND_NAME       = "Mako Heating";          // e.g. "AirPro"
export const BRAND_FULL_NAME  = "Mako Heating Cooling & Electrical";           // e.g. "AirPro Heating & Air Conditioning"
export const BRAND_LEGAL_NAME = "Mako Heating Cooling & Electrical";          // e.g. "AirPro Heating & Air Conditioning, Inc."
export const BRAND_TAGLINE    = "Professional HVAC Service & Repair in San Jose";        // e.g. "Fast, Honest HVAC in San Jose"
export const BRAND_LICENSE    = "License #1086975 · C-20";  // e.g. "License #1069959"
export const BRAND_INITIALS   = "MHC";             // e.g. "AP" — used in decorative elements

// ─── Contact ──────────────────────────────────────────────────────────────────
export const PHONE_LABEL  = "(408) 766-2271";   // e.g. "(408) 898-6999"
export const PHONE_TEL    = "tel:14087662271";  // e.g. "tel:14088986999"
export const BRAND_EMAIL  = "artem@makoservice.com";                    // e.g. "info@airpro.com"
export const BRAND_ADDRESS = "5805 Charlotte Dr #333 San Jose CA 95123";                 // e.g. "1593 Trieste Way, San Jose, CA 95122"
...
export const PRIMARY_COLOR   = "#0D1124";   // brand accent — buttons, links, gold
...
export const SEO_TITLE       = "Mako Heating Cooling & Electrical — San Jose HVAC";
export const SEO_DESCRIPTION = "Mako Heating Cooling & Electrical — San Jose's trusted HVAC professionals. Professional HVAC Service & Repair in San Jose.";
...
export const HERO_CTA_SECONDARY = "Call 408) 766-2271";   // patched to PHONE_LABEL
export const HERO_SIDE_RAIL_TEXT = "Serving Santa Clara County";
export const HERO_IMG_ALT       = "Mako Heating Cooling & Electrical technician servicing a residential HVAC system in San Jose";
...
export const TRUST_PILLARS = [
  ...
  {
    num: "04",
    eyebrow: "The Mako Heating Promise",
...
export const SERVICES = [
  ...
  {
    title: "Furnace Installation/Replac…",
...
export const TESTIMONIALS = [
  {
    quote: "He came same-day, fixed our fridge inside of 30 minutes. Fast, professional, and a great value for an emergency repair.",
    author: "Emily D.",
    role: "Google Review · 5★",
  },
  {
    quote: "Great experience with the HVAC repair. Technician arrived on time, quickly diagnosed the issue and had everything running smoothly again.",
    author: "Chethan",
    role: "Google Review · 5★",
  },
  {
    quote: "Super fast and the technician is pretty knowledgeable. Fixed the condenser in one shot. Highly recommend them for future work.",
    author: "Nirav T.",
    role: "Google Review · 5★",
  },
  {
    quote: "They are quick, efficient, and friendly. Fixed my furnace problem fast and the price was on point.",
    author: "Lucila R.",
    role: "Google Review · 5★",
  }
];
...
export const FAQ_ITEMS = [
  {
    ...
    a: `Yes — Mako Heating Cooling & Electrical has been proudly serving the area for years. Most appointments are booked the same week you call, and our service call department is open Monday through Friday, 8:00 AM – 5:00 PM.`,
  },
  {
    q: "Are you licensed, bonded, and insured?",
    a: `Absolutely. Mako Heating Cooling & Electrical is fully licensed, bonded, and insured. Every technician on our team is trained, professional, and treats your home with respect.`,
  },
  {
  ...
  },
  {
    ...
    a: "We provide AC Repair, AC Maintenance, AC Installation/Replacement, Emergency AC Repair, Furnace Repair, Furnace Installation/Replacement — for both residential and commercial properties. Installations, replacements, repairs, and…",
  },
  {
